  ...
  const renderActivityTab = () => {
    ...
    return (
      <>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white dark:bg-[#1a2632] rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700">
            <div className="flex justify-between items-start mb-3">
              <div className="text-gray-500 dark:text-gray-400 text-sm">Total de Logs</div>
          ...
          <div className="bg-white dark:bg-[#1a2632] rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700">
            <div className="flex justify-between items-start mb-3">
              <div className="text-gray-500 dark:text-gray-400 text-sm">Usuários Únicos</div>
          ...
          <div className="bg-white dark:bg-[#1a2632] rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700">
            <div className="flex justify-between items-start mb-3">
              <div className="text-gray-500 dark:text-gray-400 text-sm">Total de Logins</div>
              <div className="p-2 rounded-lg bg-green-50 dark:bg-green-900/20">
                <LogIn className="h-4 w-4 text-green-500 dark:text-green-400" />
              </div>
            </div>
            ...
            {loadingStats ? (
              ...
              <div className="text-2xl font-bold text-gray-800 dark:text-white">
                {formatNumber(auditStats.loginCount)}
              </div>
            )}
          ...
          <div className="bg-white dark:bg-[#1a2632] rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700">
            <div className="flex justify-between items-start mb-3">
              <div className="text-gray-500 dark:text-gray-400 text-sm">Alterações de Dados</div>
            ...
            {loadingStats ? (
              ...
              <div className="text-2xl font-bold text-gray-800 dark:text-white">
                {formatNumber(auditStats.dataChangeCount)}
              </div>
            )}
        ...
        {/* Gráfico de Atividade ao Longo do Tempo (com dados de auditoria reais) */}
        <div className="grid grid-cols-1 gap-6 mb-6">
          <div className="relative group">
            <div className="absolute inset-0 bg-white/5 dark:bg-white/5 rounded-xl blur-sm opacity-70 group-hover:opacity-100 transition-opacity"></div>
            <div className="relative bg-white dark:bg-[#1a2632] rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-800 h-full group-hover:shadow-md transition-all">
              <div className="mb-4 flex items-center justify-between">
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Atividade ao Longo do Tempo</h3>
                <div className="p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                  <Activity className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                </div>
              </div>
              
              {loadingStats || dailyActivityData.length === 0 ? (
                <div className="h-72 flex items-center justify-center">
                  {loadingStats ? (
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">Sem dados de atividade disponíveis</p>
                    </div>
                  )}
                </div>
              ) : (
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Area 
                        ...
                        animationDuration={1500}
                      />
                      {dailyActivityData.length > 10 && (
                        <Brush 
                          dataKey="date" 
                          height={20} 
                          stroke="#8884d8"
                          startIndex={Math.max(dailyActivityData.length - 10, 0)}
                        />
                      )}
                    </AreaChart>
                  </ResponsiveContainer>
    ...
    return (
      <>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          {/* Logins */}
          <div className="bg-white dark:bg-[#1a2632] rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700 col-span-1 sm:col-span-2 lg:col-span-2">
            <div className="flex justify-between items-start mb-3">
              <div className="text-gray-500 dark:text-gray-400 text-sm">Atividade por Ação</div>
              <div className="p-2 rounded-lg bg-cyan-50 dark:bg-cyan-900/20">
                <Activity className="h-4 w-4 text-cyan-500 dark:text-cyan-400" />
              </div>
            </div>
            
            {loadingStats || actionCountData.length === 0 ? (
              <div className="h-16 w-full bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
            ) : (
              <div className="overflow-x-auto">
                <div className="flex space-x-2">
                  {actionCountData.slice(0, 4).map((action, index) => (
                    <div key={index} className="flex-1 min-w-0">
                      <div className={`text-xs font-medium mb-1 text-center truncate ${
                      ...
                      <div className="h-10 bg-gray-100 dark:bg-gray-800 rounded-md relative overflow-hidden">
                        <div 
                          className={`absolute bottom-0 left-0 w-full ${
                            index === 0 ? 'bg-green-500 dark:bg-green-600' :
                            index === 1 ? 'bg-cyan-500 dark:bg-cyan-600' :
                            index === 2 ? 'bg-amber-500 dark:bg-amber-600' :
                            'bg-blue-500 dark:bg-blue-600'
                          }`} 
                          style={{ 
                            height: `${Math.min(100, (action.count / Math.max(...actionCountData.map(a => a.count))) * 100)}%` 
                          }}
                        >
                        </div>
                      </div>
                      <div className="text-xs font-medium mt-1 text-center text-gray-600 dark:text-gray-400">
                        {action.count}
                      </div>
                    </div>
                  ))}
        ...
        <div className="grid grid-cols-1 gap-6 mb-6">
          <div className="relative group">
            ...
            <div className="relative bg-white dark:bg-[#1a2632] rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-800 h-full group-hover:shadow-md transition-all">
              <div className="mb-4 flex items-center justify-between">
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Sessões Ativas (Amostra)</h3>
                <div className="p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                  <Shield className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                </div>
              </div>
              
              {loadingStats || userSessions.length === 0 ? (
                <div className="h-64 flex items-center justify-center">
                  {loadingStats ? (
                    <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-600"></div>
                  ) : (
                    <div className="text-center">
                      <AlertTriangle className="h-12 w-12 text-gray-400 mx-auto mb-3" />
                      <p className="text-gray-500 dark:text-gray-400">Sem dados de sessões disponíveis</p>
                    </div>
                  )}
                </div>
              ) : (
                  ...
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead>
                      <tr>
                        ...
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Usuário</th>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">IP</th>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Dispositivo</th>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Último Acesso</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {userSessions.slice(0, 6).map((session) => (
                        <tr key={session.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/30">
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">{session.id}</td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">{session.usuario_id}</td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">{session.ip}</td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                            <span className="px-2.5 py-1 inline-flex text-xs font-medium rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300">
                              {session.dispositivo || session.user_agent?.split(' ')[0] || 'Desconhecido'}
                            </span>
                          </td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">{formatDate(session.ultimo_acesso)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
        ...
        {/* Atividade por Tipo de Operação e Módulo */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          {/* Atividade por Tipo de Operação */}
          <div className="relative group">
            <div className="absolute inset-0 bg-white/5 dark:bg-white/5 rounded-xl blur-sm opacity-70 group-hover:opacity-100 transition-opacity"></div>
            <div className="relative bg-white dark:bg-[#1a2632] rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-800 h-full group-hover:shadow-md transition-all">
              <div className="mb-4 flex items-center justify-between">
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Atividade por Tipo de Operação</h3>
                <div className="p-1.5 bg-amber-50 dark:bg-amber-900/20 rounded-md">
              ...
              {loadingStats || actionCountData.length === 0 ? (
                <div className="h-64 flex items-center justify-center">
                  {loadingStats ? (
                    ...
                    <div className="text-center">
                      <AlertTriangle className="h-12 w-12 text-gray-400 mx-auto mb-3" />
                      <p className="text-gray-500 dark:text-gray-400">Sem dados de ações disponíveis</p>
                    </div>
                  )}
                </div>
              ) : (
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <defs>
                        {['login', 'create', 'update', 'delete', 'other'].map((type, index) => (
                          <linearGradient key={type} id={`color${type}`} x1="0" y1="0" x2="0" y2="1">
                            <stop offset="0%" stopColor={
                              index === 0 ? chartColors.gradient.green[0] :
                              index === 1 ? chartColors.gradient.cyan[0] :
                              index === 2 ? chartColors.gradient.amber[0] :
                              index === 3 ? chartColors.gradient.red[0] :
                              chartColors.gradient.blue[0]
                            } />
                            <stop offset="100%" stopColor={
                              index === 0 ? chartColors.gradient.green[1] :
                              index === 1 ? chartColors.gradient.cyan[1] :
                              index === 2 ? chartColors.gradient.amber[1] :
                              index === 3 ? chartColors.gradient.red[1] :
                              chartColors.gradient.blue[1]
                            } />
                          </linearGradient>
                        ))}
                      </defs>
                      <Pie
                        data={actionCountData.slice(0, 5)}
                        cx="50%"
                        cy="50%"
                        innerRadius={60}
                        outerRadius={80}
                        ...
                        animationBegin={300}
                      >
                        {actionCountData.slice(0, 5).map((entry, index) => {
                          const actionType = 
                            entry.action.toLowerCase().includes('login') || entry.action.toLowerCase().includes('autenticar')
                              ? 'login'
                              : entry.action.toLowerCase().includes('criar') || entry.action.toLowerCase().includes('adicionar')
                                ? 'create'
                                : entry.action.toLowerCase().includes('atualizar') || entry.action.toLowerCase().includes('editar')
                                  ? 'update'
                                  : entry.action.toLowerCase().includes('excluir') || entry.action.toLowerCase().includes('remover')
                                    ? 'delete'
                                    : 'other';
                          
                          return <Cell key={`cell-${index}`} fill={`url(#color${actionType})`} />;
                        })}
                      </Pie>
                      <Tooltip />
                    </PieChart>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white dark:bg-[#1a2632] rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-800 h-full group-hover:shadow-md transition-all">
              <div className="mb-4 flex items-center justify-between">
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Logs por Módulo</h3>
                <div className="p-1.5 bg-cyan-50 dark:bg-cyan-900/20 rounded-md">
              ...
              {loadingStats || moduleCountData.length === 0 ? (
                ...
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart
                      data={moduleCountData.slice(0, 5)}
                    ...
                    >
                      ...
                      <Tooltip content={<CustomTooltip />} />
                      <defs>
                        <linearGradient id="barGradientModuleVert" x1="0" y1="0" x2="0" y2="1">
                          <stop offset="0%" stopColor={chartColors.gradient.cyan[0]} />
                          <stop offset="100%" stopColor={chartColors.gradient.cyan[1]} />
                        </linearGradient>
                      </defs>
                      <Bar 
                        dataKey="count" 
                        name="Logs" 
                        fill="url(#barGradientModuleVert)" 
                        radius={[4, 4, 0, 0]}
                        barSize={30}
                        animationDuration={1500}
                      />
